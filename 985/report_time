...
<TITLE>南京大学学科建设与发展规划办公室</TITLE>
<META HTTP-EQUIV="Content-Type" CONTENT="text/html; charset=gb2312">
<style>
A.menu:link {TEXT-DECORATION: none;color:#ffffff;cursor:hand;}
A.menu:visited {TEXT-DECORATION: none;color:#ffffff}
A.menu:active {TEXT-DECORATION: none;color:#000000;cursor:hand;}
A.menu:hover {TEXT-DECORATION:none;color:#ffff00;cursor:hand;}

A.menu02:link {TEXT-DECORATION: none;color:#0066cc;}
A.menu02:visited {TEXT-DECORATION: none;color:#000000;}
A.menu02:active {TEXT-DECORATION: none;color:#000000;}
A.menu02:hover {TEXT-DECORATION: none;color:#ff0000;}
...
body {background:url('images/top_red.jpg')  center 0  no-repeat;BACKGROUND-COLOR:#F0E3B6; }
</style>
...
function showMenu(a){
	...
	for (i=0;i<9;i++){
		mObj = eval(menu[i]);
		if (menu[i]!=a) mObj.style.visibility="hidden";
//		if (menu[i]!=a) hideMenu(menu[i]);
	}
}
	...
	<TR>
		<TD >
				<table border="0" id="table19" cellpadding="0" cellspacing="1" height="33" width="100%">
					...
					<td align="center" id="机构设置"  onMouseOver="turnon(this);showMenu('l1')" onMouseOut="turnoff(this);hideMenu('l1')" bgcolor="#DC0000"  onclick="window.location='#'">
...
机构设置</b></font></span></font></td>
					...
					<td align="center" id="新闻快讯"  onMouseOver="turnon(this);showMenu('l3')" onMouseOut="turnoff(this);hideMenu('l3')" bgcolor="#DC0000"  onclick="window.location='news.asp?id=3&s_id=5'">
